...
public class MonsterBear : Monster {
    ...
    public override string MonsterType => "Monster Bear";

    private const string ANIMATION_CHASE = "Bear Chase";
    private const string ANIMATION_HIT = "Bear Hit";
    private const string ANIMATION_DIE = "Bear Die";
